...
class RHD_train_singlehand(torch.utils.data.Dataset):
    def __init__(self, root, image_dir,singlehand_anno, background_set, data_size):
        self.image_paths = []
        ...
        num_train_begin = int(background_set*data_size)
        num_train_end = int(background_set*data_size + data_size)
